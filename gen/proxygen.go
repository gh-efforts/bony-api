...
func main() {
	if err := generate("./", "bony_api", "bony_api", "proxy_gen.go"); err != nil {
...
func generate(path, pkg, outpkg, outfile string) error {
	...
	for fn, f := range ap.Files {
		if !strings.HasSuffix(fn, "interface.go") {
			continue
		}
		//fmt.Println("F:", fn)
	...
	err = doTemplate(w, m, `// Code generated by bony/gen/api. DO NOT EDIT.
